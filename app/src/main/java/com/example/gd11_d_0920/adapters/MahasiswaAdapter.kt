package com.example.gd11_d_0920.adapters
...
import com.example.gd11_d_0920.AddEditActivity
import com.example.gd11_d_0920.MainActivity
import com.example.gd11_d_0920.R
import com.example.gd11_d_0920.models.Mahasiswa
import java.util.*
...
class MahasiswaAdapter (private var mahasiswaList: List<Mahasiswa>, context: Context) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val tvNama: TextView
        val tvNPM: TextView
        val tvFakultas: TextView
        val tvProdi: TextView
        val btnDelete: ImageButton
        val cvMahasiswa: CardView
